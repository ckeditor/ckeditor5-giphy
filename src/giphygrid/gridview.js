...
export default class GridView extends View {
	/**
	 * Creates an instance of a color grid containing {@link module:ui/colorgrid/colortile~TileView tiles}.
	 *
	 ...
	 * required to create the {@link module:ui/colorgrid/colortile~TileView tiles}.
	...
	/**
	 * Fired when the `TileView` for the picked item is executed.
	 *
	 * @event execute
...
/**
 * A color definition used to create a {@link module:ui/colorgrid/colortile~TileView}.
 *
 *		{
 *			color: 'hsl(0, 0%, 75%)',
*			label: 'Light Grey',
...
* It is used as value of background-color style in {@link module:ui/colorgrid/colortile~TileView}.
* @property {String} label String used as label for {@link module:ui/colorgrid/colortile~TileView}.
* @property {Object} options Additional options passed to create a {@link module:ui/colorgrid/colortile~TileView}.
* @property {Boolean} options.hasBorder A flag that indicates if special a CSS class should be added
* to {@link module:ui/colorgrid/colortile~TileView}, which renders a border around it.
*/
